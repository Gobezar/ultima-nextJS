...
import Map from "./Map";
import goodPlaceUltima from "../../../public/goodPlaceUltima.png";
  ...
  return (
    <>
      <div
        ...
        className="pt-[122px] pb-[127px] w-full bg-[#272727] flex relative mobile:pt-[50px] mobile:pb-[50px] mobile:bg-[#2D2D2D] mobile:flex-col"
      >
        <div className="w-[50%] flex justify-center mobile:hidden">
          <div className="flex flex-col items-start text-left halfContainer relative">
            <span
            ...
            <span className="font-semibold text-[20px] leading-[24px] text-[#FFFFFF] laptop:text-[17px] mb-[30px]">
              ...
              <span className="font-light cursor-pointer">
                <a href="tel:+79027172777" className="font-light">
                  +79027172777
                </a>
              </span>
            </span>
            ...
            <div className="absolute bottom-[-270px] left-0 w-[220px] h-[220px]">
              <Image
                src={goodPlaceUltima}
                alt="goodPlace"
                fill
        ...
        <div className="w-full justify-center flex-col items-center desktop:hidden laptop:hidden tablet:hidden mobile:flex ">
          ...
          <span className="font-semibold leading-[24px] text-[#FFFFFF] text-[15px] mb-[20px]">
            г. Саратов, ул. Танкистов, 84А
          </span>
