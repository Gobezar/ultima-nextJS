...
const portfolioData = [
  ...
  },
  {
    ...
    title: "Химчистка",
    description:
      "Полная химчистка салона с разбором сидений и обработкой парогенератором. Удалены все загрязнения и неприятные запахи. Результат — чистый, свежий и как новый салон за 2 дня.",
  },
  {
    id: 3,
    car: "KIA",
    ...
    description:
      "Выполнена полная перетяжка салона в кожу Nappa с контрастной строчкой. Обновлены сиденья, дверные карты и руль. Процесс занял 7 дней.",
  },
  {
    id: 4,
    car: "Scoda",
    title: "Мойка кузова",
    description:
      "Комплексная мойка кузова с использованием профессиональной автохимии и бесконтактной технологии. Покрытие обработано воском для защиты от загрязнений.",
  },
  {
    id: 5,
    car: "Lamborghini",
    ...
    description:
      "Премиальная мойка с обработкой кузова, полировкой, чисткой салона и уходом за кожей. Использованы только деликатные средства. Работа выполнена за 1 день.",
  },
  {
    id: 6,
    car: "Honda",
    title: "Оклейка пленкой",
    description:
      "Оклейка кузова матовой виниловой плёнкой для придания спортивного стиля. Подготовка и нанесение выполнены с точностью до миллиметра. Срок выполнения — 4 дня.",
  },
  {
    id: 7,
    car: "Audi",
    title: "Оклейка пленкой",
    description:
      "Выполнена частичная оклейка зон риска защитной прозрачной плёнкой. Теперь кузов защищён от сколов и царапин. Работа заняла 3 дня.",
  },
  {
    id: 8,
    car: "ВАЗ 2114",
