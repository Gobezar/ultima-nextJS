...
const portfolioData = [
  ...
  },
  {
    ...
    title: "Оклейка пленкой",
    description:
      "Оклейка матовым полиуретаном, выполнили установку заводских наклеек на кузов. Тонировка задней полусферы и затемнение люка полиуретаном",
  },
  {
    id: 9,
    ...
    title: "Оклейка пленкой",
    description:
      "Замена цвета виниловой пленкой",
  },
  {
    id: 10,
